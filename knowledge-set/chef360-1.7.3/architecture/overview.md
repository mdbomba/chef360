...
Infrastructure can be provisioned with Terraform, native cloud or hypervisor
tools, configuration management, or manual workflows. These are automation
choices rather than additional Chef 360 deployment modes. The same Linux guest
and installation requirements apply across AWS, Azure, KVM, Hyper-V, and
Proxmox; see the provider-neutral operations guidance in this knowledge set.
